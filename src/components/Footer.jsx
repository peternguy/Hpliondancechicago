...
const links = [
    ...
    {href: 'https://facebook.com', icon: <FaFacebook size={28}/>},
    {href: 'https://youtube.com', icon: <FaYoutube size={28}/>},
  ...
  return (
    <footer className='w-screen bg-violet-300 py-4 text-black'>
        <div className='container mx-auto flex flex-col items-center justify-between gap-4 px-4 md:flex-row'>
            <p className='text-center text-sm md:text-left'>&copy; hpliondance 2022. All rights reserved</p>
            ...
            <div className="text-center text-sm md:text-right font-circular-web flex items-center gap-2">
